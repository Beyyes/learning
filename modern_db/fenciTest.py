...
def judge(words_res):
     for word, flag in words_res:
          if word.encode('utf-8') == '教' or word is '师事' or word is '从师' or word is '师从':
              next = words_res.next()
              for tmp in next:
                   print tmp + ' ',
              print
...
if __name__ == '__main__':
     words_res = pseg.cut('梅兰芳，男，京剧旦角。原名澜，字畹华、浣华，号鹤鸣，乳名群儿，斋名缀玉轩，别署缀玉轩主人。'
     '祖籍江苏泰州市之东薛家庄。生于北京李铁拐斜街45号（今铁树斜街101号）。父明瑞，字竹芬，小生改花旦，母为杨隆寿之长女长玉。'
     '梅兰芳童年时并未表现出过人的艺术天分，相貌也很平常，两只眼睛有些近视，眼皮总下垂。眼睛既不能外露，又不能正视，显着无神的样子，见了生人还不会说话。'
     '因此他姑母用八个字形容他：“言不出众，貌不惊人。”七岁的梅兰芳在住家附近一个私塾就读，初时因为读书不太用心，成绩自然不好。'
     '开始学戏是他八岁时，请来教戏的是名小生朱素云的哥哥朱小霞，朱先生按照教青衣传统的方法，先教他唱《二进宫》。'
     '谁想四句极普通的老腔，教了很长时间，他总是不能上口，先生见他进步太慢，认为这孩子没有希望，就对他说：“祖师爷没给你这碗饭吃。”'
     '说罢竟拂袖而去，再也不来教他了。梅兰芳成名后，有一次爷俩又见面了。朱先生很不好意思地对他说“我那时真是有眼不识泰山。”'
     '梅兰芳笑着说：“您快别说了，我受您的益处太大了，要不挨您这一顿骂，我还不懂得发奋苦学呢！”'
     '梅兰芳幼从吴菱仙习青衣，10岁登台在北京广和楼演出《天仙配》，工花旦，1908年搭喜连成班')
